    ...
    return (
        <div className='col-span-3 flex flex-col gap-3'>
            ...
            <div className="w-full flex items-center gap-2 border border-slate-200 rounded-[2px] pl-3 pr-2">
                <MagnifyingGlassIcon />
                <Input placeholder='find message by' className="w-full h-[33px] rounded-none text-xs border-0 p-0 focus-visible:ring-0 focus-visible:ring-offset-0" />
            </div>
            <div className='flex gap-3 items-center'>
                <button className="w-full flex items-center gap-[2px]">
                    <p className="text-slate-950 rounded-[2px] rounded-r-none px-1 py-[1px] text-xs underline">text</p>
                    <p className="text-slate-950 rounded-[2px] rounded-r-none px-1 py-[1px] text-xs">username</p>
                    <p className="text-slate-950 rounded-[2px] rounded-r-none px-1 py-[1px] text-xs">date</p>
                </button>
            </div>
            </div>
            ...
            <div className="w-full flex items-center gap-2 border border-slate-200 rounded-[2px] pl-3 pr-2">
                <MagnifyingGlassIcon />
                <Input placeholder='find chat' className="w-full h-[33px] rounded-none text-xs border-0 p-0 focus-visible:ring-0 focus-visible:ring-offset-0" />
            </div>
            <button className="w-full flex items-center gap-[2px] border-b border-slate-200 pb-2">
                <PlusIcon />
                <p className="text-slate-950 rounded-[2px] rounded-r-none px-1 py-[1px] text-xs">add a chat</p>
            </button>
            {/*
